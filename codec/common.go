...
func init() {
	InitCodecLogger(logrus.New())
}

func InitCodecLogger(gl *logrus.Logger) {
	logger = gl.WithFields(logrus.Fields{"module": "codec"})
}

// SetFFLogLevel set ffmpeg log level
func SetFFLogLevel(level int) {
